...
- **Zoom session 8:00-9:30 PDT** - Mixed models
    - Pre-recorded lecture - Mixed model association testing ([slides](https://si.biostat.washington.edu/sites/default/files/modules/Mixed_Model_Association_Testing_2020.pdf))
