...
- **Zoom session 11:30-13:15 PDT** - Introduction and Genomic Data Storage
    - Introduction ([video](https://washington.zoom.us/rec/share/2pB5Dej36mBJfKPk1Rz1AZ8nQ7rOX6a82yAf__EKxBwR9YbEVa5w9EQU0It8PXFv?startTime=1596047526000)) ([slides](https://docs.google.com/presentation/d/17DFvIH97RhcY6gq-BRYsxL-0r2jgl_p1-EMsgGXIYoE/edit?usp=sharing))
    ...
    - Discussion ([video](https://washington.zoom.us/rec/share/2pB5Dej36mBJfKPk1Rz1AZ8nQ7rOX6a82yAf__EKxBwR9YbEVa5w9EQU0It8PXFv?startTime=1596053230000))
- **Zoom session 13:45-14:30 PDT** - Phenotype harmonization
    ...
    - Discussion ([video](https://washington.zoom.us/rec/share/2pB5Dej36mBJfKPk1Rz1AZ8nQ7rOX6a82yAf__EKxBwR9YbEVa5w9EQU0It8PXFv?startTime=1596057633000))
...
- **Zoom session 8:00-9:45 PDT** - Association tests, Part I
    ...
    - Discussion ([video](https://washington.zoom.us/rec/share/2It5MZ_C2zJOR8_gxEjkcbYHLIC1T6a82idI-vZcmhlI6yqFOqXZ2sB70dx40myL?startTime=1596126935000))
- **Zoom session 10:15-11:45 PDT** - Association tests, Part II
    ...
    - Discussion ([video](https://washington.zoom.us/rec/share/2It5MZ_C2zJOR8_gxEjkcbYHLIC1T6a82idI-vZcmhlI6yqFOqXZ2sB70dx40myL?startTime=1596133607000))
- **Zoom session 12:45-14:30 PDT** - Population Structure and Relatedness
    - Pre-recorded lecture - Population structure inference ([video - 33 min](https://drive.google.com/file/d/1hLtTP1b6aUDBbz9mQ2i9J9Yg3Zbfsvvm/view?usp=sharing)) ([slides](https://si.biostat.washington.edu/sites/default/files/modules/Population_Structure_Inference_2020.pdf))
    - Pre-recorded lecture - Relatedness inference ([video - 25 min](https://drive.google.com/file/d/1JMlVvEGU4x9u2UBIJiw7RRIFUrbNdj3f/view?usp=sharing)) ([slides](https://si.biostat.washington.edu/sites/default/files/modules/Relatedness_Inference_2020.pdf))
    ...
    - Discussion ([video](https://washington.zoom.us/rec/share/2It5MZ_C2zJOR8_gxEjkcbYHLIC1T6a82idI-vZcmhlI6yqFOqXZ2sB70dx40myL?startTime=1596143849000))

**Friday, July 31**

- **Zoom session 8:00-9:30 PDT** - Mixed models
    - Pre-recorded lecture - Mixed model association testing ([video - 42 min](https://drive.google.com/file/d/1H01K3rhjsKiFCmIcXRRkPxoGF_a6DojL/view?usp=sharing)) ([slides](https://si.biostat.washington.edu/sites/default/files/modules/Mixed_Model_Association_Testing_2020.pdf))
    - Exercises in breakout rooms - [Mixed models in R](https://uw-gac.github.io/SISG_2020/mixed-models.html)
    - Discussion ([video](https://washington.zoom.us/rec/share/1cFoKbPWyjxOboHtxEvNZ44qDLnYeaa81nMZqPtbzBtXA_Hv7mXPKXmSe_9BHeyb?startTime=1596212284000))
- **Zoom session 9:45-11:30 PDT** - Variant annotation
    ...
    - Discussion ([video](https://washington.zoom.us/rec/share/1cFoKbPWyjxOboHtxEvNZ44qDLnYeaa81nMZqPtbzBtXA_Hv7mXPKXmSe_9BHeyb?startTime=1596216918000)) - includes 30 min of open questions and discussion
- **Zoom session 12:30-13:45 PDT** - Working in the cloud
    ...
    - Exercises in breakout rooms - [Running a GWAS workflow](https://uw-gac.github.io/SISG_2020/exercises-running-a-gwas-workflow.html)
    - Discussion ([video](https://washington.zoom.us/rec/share/1cFoKbPWyjxOboHtxEvNZ44qDLnYeaa81nMZqPtbzBtXA_Hv7mXPKXmSe_9BHeyb?startTime=1596227666000))
- **Zoom session 14:00-14:30 PDT** - Open session for questions/advice
    - Discussion ([video](https://washington.zoom.us/rec/share/1cFoKbPWyjxOboHtxEvNZ44qDLnYeaa81nMZqPtbzBtXA_Hv7mXPKXmSe_9BHeyb?startTime=1596229316000))
